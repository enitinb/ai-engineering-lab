# Example: Persistent artifact, Well-Architected-style review

This example shows how the skill uses a Well-Architected-style lens without tying the assessment to a specific cloud, vendor, or tool.

## User prompt

```text
/ai-dlc-maturity --well-architected Assess our AI-DLC practice. We use AI across requirements elaboration, coding, test generation, PR review, and release notes. We have CI gates, but no standard audit schema for model identity, prompt version, rule version, approval, and linked tests.
```

## Expected skill behavior

The skill should create or update the persistent assessment artifact and organize findings across lifecycle stages and review pillars. It should preserve the user's answers, then append a maturity assessment, top gaps, and priority actions.

## Expected assessment structure

```md
## Well-Architected-Style Review Summary
