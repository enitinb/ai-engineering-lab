#!/usr/bin/env python3
"""Validate the structure of the skill eval cases file (skill-eval-cases.jsonl).

Each line must be a JSON object with:
- skills: non-empty list of skill names (must include "ai-route-advisor")
...
expected_behavior as the rubric when grading model output (see README.md).
"""
...
EXPECTED_SKILL = "ai-route-advisor"
DEFAULT_CASES = Path(__file__).resolve().parent / "skill-eval-cases.jsonl"
